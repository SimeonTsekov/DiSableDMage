...
namespace RTS_Cam
{
    ...
    public class RTS_Camera : MonoBehaviour
    {
        ...
        {
            var position = m_Transform.position;
            Vector3 targetPos = new Vector3(targetFollow.position.x, position.y, targetFollow.position.z) + targetOffset;
        ...
        private void LimitPosition()
        {
            ...
            var position = m_Transform.position;
            position = new Vector3(Mathf.Clamp(position.x, -limitX, limitX),
                position.y,
                Mathf.Clamp(position.z, -limitY, limitY));
            m_Transform.position = position;
        }
